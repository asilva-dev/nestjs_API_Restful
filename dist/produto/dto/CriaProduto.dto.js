...
__decorate([
    ...
    (0, class_validator_1.IsNotEmpty)({ message: 'Nome da característica não pode ser vazio' }),
    __metadata("design:type", String)
], CaracteristicaProdutoDTO.prototype, "nome", void 0);
__decorate([
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsNotEmpty)({ message: 'Descrição da característica não pode ser vazia' }),
    __metadata("design:type", String)
